              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-2">
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-emerald-500 hover:bg-emerald-600 text-white text-sm font-bold rounded-xl shadow-md transition-all hover:scale-[1.01] active:scale-95 cursor-pointer"
                  >
