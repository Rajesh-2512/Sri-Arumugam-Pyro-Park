...
import FireworksHero from '@/components/shop/FireworksHero';
import DiwaliCountdown from '@/components/shop/DiwaliCountdown';
import { Sparkles, Flame, Percent, ShieldCheck } from 'lucide-react';
...
export default async function HomePage({ searchParams }: { searchParams: Promise<SearchParams> }) {
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-10">
      ...
      {/* Interactive Fireworks Hero Banner */}
      <FireworksHero />

      {/* Live Diwali Countdown & Pre-Booking Card */}
      <DiwaliCountdown />
      ...
      {/* Trust Badges Section (NPK Crackers Style Light Cards) */}
